...
chainer.serializers.load_npz(os.path.join('result_cifar10', 'model.npz'), model)

# テストデータをロード
_, test = chainer.datasets.get_cifar10(ndim=3)
...
plt.savefig(os.path.join('result_cifar10', 'result.png'))
